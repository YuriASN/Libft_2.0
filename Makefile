...
SRC =	ft_isalpha.c	ft_isdigit.c	ft_isalnum.c	ft_isascii.c	\
		ft_isprint.c	ft_isspace.c	ft_strlen.c		ft_memset.c		\
		...
		ft_putstr_fd.c	ft_putendl_fd.c	ft_putnbr_fd.c 	ft_intswap.c	\
		ft_abs.c		ft_atoi_overflow.c	\
		ft_printf_bonus.c	printf_utils_bonus.c	get_conversions.c	\
		justify_right.c	bonus_flags.c	bonus_utils.c	dot_flag.c		\
